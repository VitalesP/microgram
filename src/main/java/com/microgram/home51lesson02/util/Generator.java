...
public final class Generator {
    ...
    private static String makeGibberish(int randomAmount, int min) {
        ...
        var gibberish = Stream.generate(com.microgram.home51lesson02.util
                .Generator::takeOneWord).limit(wordCount).collect(Collectors.joining(" "))
                .strip();
    ...
    public static String makeEmail() {
        var prefix = removeExtra.matcher(makeGibberish(2,0))
                .replaceAll("").toLowerCase();
        var suffix = removeExtra.matcher(makeGibberish(2,0))
                .replaceAll("").toLowerCase();
